...
class Model_obj_CAR_NK:
    ...
    def Cell_type_R_L(self, NK_cell, Tumor_cell, limts,CAR_frac=1.0):
        R,L = R_L_Expression(NK_cell, Tumor_cell, limts,CAR_frac)
...
def R_L_Expression(NK_cell, Tumor_cell, limts,CAR_frac=None):
    # Receptor Lygand Interaction
    data_R_type, data_L_type = R_L_data(NK_cell, Tumor_cell, limts,CAR_frac=CAR_frac)
